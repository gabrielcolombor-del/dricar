  ...
  return (
    <>
      ...
      <main className="flex-1 w-full bg-white dark:bg-[#070f26] transition-colors duration-300">
        ...
        {/* Banner Title */}
        <section className="bg-[#F8F8F8] dark:bg-[#040817] py-16 border-b border-gray-200 dark:border-white/10 transition-colors duration-300">
          <div className="max-w-[1200px] mx-auto px-6">
            <h1 className="text-[28px] md:text-[40px] font-extrabold text-brand-blue dark:text-blue-400 uppercase leading-none mb-2">Quem Somos</h1>
            <p className="text-gray-600 dark:text-gray-300 text-lg">Conheça a história e os valores que movem a Dri-Car Veículos.</p>
          </div>
        </section>
        ...
        <section className="max-w-[1200px] mx-auto py-20 px-6">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="flex-1 space-y-6 text-gray-700 dark:text-gray-300">
              <h2 className="text-[24px] md:text-[32px] font-bold text-gray-800 dark:text-white leading-tight">Nossa História</h2>
            ...
            <div className="w-full lg:w-[500px] flex-shrink-0">
              <div className="relative w-full aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl border-4 border-[#F8F8F8] dark:border-white/10">
                <Image 
        ...
        <section className="bg-[#F8F8F8] dark:bg-[#040817] py-20 border-t border-b border-gray-200 dark:border-white/10 transition-colors duration-300">
          <div className="max-w-[1200px] mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              {/* Mission */}
              <div className="bg-white dark:bg-[#0e1b42] dark:border dark:border-white/10 p-8 rounded-[20px] shadow-sm hover:shadow-md transition-shadow flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-full bg-brand-blue/10 dark:bg-blue-400/10 flex items-center justify-center mb-6 text-brand-blue dark:text-blue-400">
                ...
                <h3 className="text-xl font-bold text-brand-blue dark:text-blue-400 mb-4 uppercase">Missão</h3>
                <p className="text-gray-600 dark:text-gray-300 text-[15px] leading-relaxed font-light">
              ...
              <div className="bg-white dark:bg-[#0e1b42] dark:border dark:border-white/10 p-8 rounded-[20px] shadow-sm hover:shadow-md transition-shadow flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold text-brand-blue dark:text-blue-400 mb-4 uppercase">Visão</h3>
                <p className="text-gray-600 dark:text-gray-300 text-[15px] leading-relaxed font-light">
              ...
              <div className="bg-white dark:bg-[#0e1b42] dark:border dark:border-white/10 p-8 rounded-[20px] shadow-sm hover:shadow-md transition-shadow flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold text-brand-blue dark:text-blue-400 mb-4 uppercase">Valores</h3>
                <p className="text-gray-600 dark:text-gray-300 text-[15px] leading-relaxed font-light">
