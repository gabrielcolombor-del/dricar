...
export default function Footer() {
  return (
    <footer className="bg-[#333333] text-white py-12 px-6">
      <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row items-start justify-between gap-8 md:gap-4">
        ...
        <div className="flex flex-col items-center">
          <a href="https://maps.app.goo.gl/RJcYwW9h5RPSKYvq9" target="_blank" rel="noopener noreferrer" className="block hover:opacity-80 transition-opacity">
            <div className="relative w-[150px] h-[150px] rounded-lg overflow-hidden border-2 border-white/10">
              <Image src="/images/maps.png" alt="Como Chegar - Maps" fill className="object-cover" />
            </div>
          </a>
          <span className="font-bold text-sm mt-3 uppercase tracking-wider">Como Chegar</span>
        </div>
        ...
        <div className="flex flex-col">
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            <li><Link href="#" className="hover:text-white transition-colors">Compre seu Carro</Link></li>
            <li><Link href="#" className="hover:text-white transition-colors">Compre sua Moto</Link></li>
          </ul>
          <div className="mt-8">
            <Link href="#" className="inline-flex items-center gap-2 border border-white/40 rounded-full py-1.5 px-4 text-xs hover:bg-white hover:text-[#333333] transition-colors">
        ...
        {/* Links: Vender */}
        <div className="flex flex-col">
          <h4 className="font-bold text-lg mb-4">Vender</h4>
          <ul className="space-y-2 text-sm text-gray-300">
            <li><Link href="#" className="hover:text-white transition-colors">Venda seu Veículo</Link></li>
            <li><Link href="#" className="hover:text-white transition-colors">Financie seu Veículo</Link></li>
          </ul>
        </div>
        ...
        <div className="flex flex-col">
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            ...
            <li><Link href="#" className="hover:text-white transition-colors">Fale com a gente</Link></li>
          </ul>
        </div>
        ...
        <div className="flex flex-col items-center md:items-end">
          ...
          <div className="flex flex-col items-center md:items-end gap-1 text-xs text-gray-300">
