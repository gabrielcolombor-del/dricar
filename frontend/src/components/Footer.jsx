      ...
      <footer className="hidden md:block bg-[#333333] dark:bg-[#040817] text-white py-12 px-6 border-t border-white/5 dark:border-white/10 transition-colors duration-300">
        <div className="max-w-[1200px] mx-auto flex flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <span className="font-bold text-sm mt-3 uppercase tracking-wider text-gray-300">Como Chegar</span>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="flex flex-col items-center gap-1 text-xs text-gray-300">
              ...
              <div className="mt-4">
                <a href="https://wa.me/5527996361212" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 border border-white/40 rounded-full py-1.5 px-4 text-xs hover:bg-white hover:text-[#333333] transition-colors">
